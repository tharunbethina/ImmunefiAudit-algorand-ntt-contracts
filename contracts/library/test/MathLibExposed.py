...
class MathLibExposed(ARC4Contract):
    ...
    def max_uint64_constant(self) -> UInt64:
        return UInt64(MathLib.max_uint64_hex)

    @abimethod(readonly=True)
    def safe_cast_uint256_to_uint64(self, a: UInt256) -> UInt64:
        return MathLib.safe_cast_uint256_to_uint64(a)
